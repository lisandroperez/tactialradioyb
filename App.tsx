...
import { User, ShieldCheck, List, X, Hash, Settings2, UserCog, Terminal, BookOpen, ChevronRight, Globe, AlertCircle, Home, Mic, MapPin, Activity, Send, Target, Volume2, ShieldAlert } from 'lucide-react';
    ...
    <div className="overflow-x-hidden relative min-h-screen selection:bg-orange-500">
          ...
          <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  ...
                  <div className="feature-card p-10 rounded-sm group">
                      ...
                      <h3 className="mono text-xl font-bold mb-4 uppercase text-white">Log de Auditoría</h3>
                  ...
                  <div className="feature-card p-10 rounded-sm group">
                      ...
                      <h3 className="mono text-xl font-bold mb-4 uppercase text-white">Canales por Equipo</h3>
                  ...
                  <div className="feature-card p-10 rounded-sm group">
                      ...
                      <h3 className="mono text-xl font-bold mb-4 uppercase text-white">Modo Táctico Fijo</h3>
      ...
      <footer className="py-32 bg-[#0e0a07] text-center border-t border-white/5 relative overflow-hidden">
          <div className="max-w-4xl mx-auto px-6 relative z-10">
              ...
              <p className="text-gray-400 mb-16 italic text-lg max-w-2xl mx-auto">"Esta aplicación es gratuita para todas las entidades oficiales y grupos de respuesta. No buscamos lucro, buscamos que ningún rescatista se quede sin comunicación."</p>
              ...
              <div className="opacity-20 flex flex-col items-center gap-4 border-t border-white/10 pt-12">
                  <p className="text-[10px] text-gray-400 uppercase tracking-[0.4em] font-bold">
                      RADIO_UBICACION_MOVIL // MISSION_CRITICAL_v3.0_STABLE
                  </p>
         ...
         <div className="w-full max-w-md space-y-6 animate__animated animate__fadeIn z-10">
            <div className="flex flex-col items-center gap-2 mb-2">
              ...
              <div className="flex items-center gap-3 bg-white/5 px-4 py-2 border border-white/10 rounded-full">
                ...
                <button onClick={() => { localStorage.removeItem('user_callsign'); setUserName(''); }} className="p-1.5 hover:bg-orange-500 hover:text-white text-gray-400 rounded-full transition-all">
                  <UserCog size={16} />
                </button>
              </div>
            </div>
